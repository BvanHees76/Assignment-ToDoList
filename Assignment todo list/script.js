...
let makeCompleteListItem = function () {
   ...
   let addToDom = function()
   {
    ...
    //delete met klik op prullenbak
    //met een klik op de prullenbak moet het list-item verdwijnen uit de DOM en database

   let storeGetForParsing = function () {
    return getData();    
   };
   const getJSObject = JSON.parse(storeGetForParsing());
   console.log(getJSObject);
